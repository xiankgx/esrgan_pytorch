...
class DenseResidualBlock(nn.Module):
    ...
    def __init__(self, filters, res_scale=0.2):
        ...
        b1 = block(in_features=1 * filters)
        b2 = block(in_features=2 * filters)
        b3 = block(in_features=3 * filters)
        b4 = block(in_features=4 * filters)
        b5 = block(in_features=5 * filters, non_linearity=False)
        self.blocks = nn.ModuleList([b1, b2, b3, b4, b5])
